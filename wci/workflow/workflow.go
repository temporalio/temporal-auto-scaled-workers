...
func (d *WorkflowRunner) pollIfDue(ctx workflow.Context) time.Duration {
	...
	// Fresh start (deadline not carried across continue-as-new): schedule the first poll
	// one interval out to match the legacy timer bootstrap, rather than polling immediately.
